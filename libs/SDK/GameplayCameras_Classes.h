...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3XUF[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_VWV4[0x4];                                   // 0x0034(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1NYM[0x10];                                  // 0x0038(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_UMAD[0x4];                                   // 0x00AC(0x0004) Fix Super Size
	...
	public:
		...
		unsigned char                                              UnknownData_GPG1[0x4];                                   // 0x011C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QY39[0x3];                                   // 0x0131(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H2MO[0x40];                                  // 0x0140(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IY6I[0x28];                                  // 0x0188(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5WIR[0x38];                                  // 0x0080(0x0038) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VMY0[0x3C];                                  // 0x009C(0x003C) MISSED OFFSET (PADDING)
