...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_M5VS[0x50];                                  // 0x0288(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_TUL1[0x8];                                   // 0x0478(0x0008) Fix Super Size
		unsigned char                                              UnknownData_E8GV[0x10];                                  // 0x0480(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DVDS[0x2];                                   // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_N2MH[0x44];                                  // 0x0054(0x0044) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F36D[0x4];                                   // 0x00B0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JZX0[0x2];                                   // 0x00B6(0x0002) MISSED OFFSET (PADDING)
