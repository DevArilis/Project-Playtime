...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_M8IU[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
	...
	{
	public:
		unsigned char                                              UnknownData_NUEY[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY) ()
