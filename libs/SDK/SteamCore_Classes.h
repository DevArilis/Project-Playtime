...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_17TX[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_URD3[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F6HN[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_SELT[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_1T5X[0x1E0];                                 // 0x0138(0x01E0) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_SRBK[0x30];                                  // 0x0048(0x0030) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JI3F[0xE0];                                  // 0x00B8(0x00E0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_S92Y[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VU3P[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H7AR[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F761[0x120];                                 // 0x00D8(0x0120) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_O4IM[0xE8];                                  // 0x0058(0x00E8) MISSED OFFSET (PADDING)

	public:
		class USteamCoreCreateSession* CreateSteamCoreSession(class UObject* WorldContextObject, TMap<class FString, struct FSteamSessionSetting> SessionSettings, const class FString& SessionName, int32_t MaxPlayers, bool bUseLAN, bool bAllowInvites, bool bUsesPresence, bool bAllowJoinViaPresence, bool bAllowJoinViaPresenceFriendsOnly, bool bAntiCheatProtected, bool bUsesStats, bool bShouldAdvertise, bool bAllowJoinInProgress, bool bUseLobbiesVoiceChatIfAvailable, float Timeout);
		static UClass* StaticClass();
	};
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_L1OK[0x90];                                  // 0x0048(0x0090) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnSuccess;                                               // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		class FScriptMulticastDelegate                             OnFailure;                                               // 0x0048(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_K8GZ[0x20];                                  // 0x0058(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		class FScriptMulticastDelegate                             OnCallback;                                              // 0x0038(0x0010) ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_ZU4G[0xE0];                                  // 0x0048(0x00E0) MISSED OFFSET (PADDING)

	public:
		class USteamCoreUpdateSession* UpdateSteamCoreSession(class UObject* WorldContextObject, TMap<class FString, struct FSteamSessionSearchSetting> Settings, const class FString& SessionName, int32_t MaxPlayers, bool bAllowJoinInProgress);
		void OnCompleted(const class FName& SessionName, bool bWasSuccessful);
		static UClass* StaticClass();
	};
	...
	{
	public:
		unsigned char                                              UnknownData_OCPL[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7PHH[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3M8P[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0JA2[0xC0];                                  // 0x00A8(0x00C0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TEWS[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EP5G[0x80];                                  // 0x0088(0x0080) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_LNYP[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_VE77[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_9IUN[0x160];                                 // 0x00F8(0x0160) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_553M[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		ESteamAttributeType GetType(const struct FSteamSessionSetting& Settings);
		...
		bool GetInteger(const struct FSteamSessionSetting& Settings, class FString* Key, int32_t* OutValue);
	...
	public:
		...
		unsigned char                                              UnknownData_7POS[0xA0];                                  // 0x0098(0x00A0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_1XXZ[0x40];                                  // 0x0068(0x0040) MISSED OFFSET (PADDING)
