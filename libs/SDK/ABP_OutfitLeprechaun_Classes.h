...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_OutfitLeprechaun.ABP_OutfitLeprechaun_C
	 * Size -> 0x0A88 (FullSize[0x0D40] - InheritedSize[0x02B8])
	 */
	class UABP_OutfitLeprechaun_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_3EEJ[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_OutfitLeprechaun(int32_t EntryPoint);
