...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IKD3[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		TArray<int32_t> GetIntegerArrayField(const class FString& FieldName);
	...
	{
	public:
		unsigned char                                              UnknownData_5RPN[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_L9Z6[0x40];                                  // 0x0048(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YY1A[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_70X6[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_O1SU[0x30];                                  // 0x00B8(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_69BP[0xD0];                                  // 0x00F8(0x00D0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F46N[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (PADDING)
