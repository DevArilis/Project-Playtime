...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MPN7[0x8];                                   // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMMemoryContainer                               LiteralMemoryStorage;                                    // 0x00D0(0x00A0) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_5K4H[0x8];                                   // 0x0170(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FRigVMByteCode                                      ByteCodeStorage;                                         // 0x0178(0x0030) NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_9FQC[0x8];                                   // 0x01A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IK0Y[0x20];                                  // 0x0228(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_G5WO[0x48];                                  // 0x02A8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
