...
namespace CG
{
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AdvancedSessions.AutoLoginUserCallbackProxy.AutoLoginUser
	 * 		Flags  -> ()
	 * Parameters:
	 * 		class UObject*                                     WorldContextObject                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 * 		int32_t                                            LocalUserNum                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class UAutoLoginUserCallbackProxy* UAutoLoginUserCallbackProxy::AutoLoginUser(class UObject* WorldContextObject, int32_t LocalUserNum)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AdvancedSessions.AutoLoginUserCallbackProxy.AutoLoginUser");
		
		UAutoLoginUserCallbackProxy_AutoLoginUser_Params params {};
		params.WorldContextObject = WorldContextObject;
		params.LocalUserNum = LocalUserNum;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UAutoLoginUserCallbackProxy.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UAutoLoginUserCallbackProxy::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AdvancedSessions.AutoLoginUserCallbackProxy");
		return ptr;
	}
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function AdvancedSessions.StartSessionCallbackProxyAdvanced.StartAdvancedSession
	 * 		Flags  -> ()
	 * Parameters:
	...
	class UStartSessionCallbackProxyAdvanced* UStartSessionCallbackProxyAdvanced::StartAdvancedSession(class UObject* WorldContextObject)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function AdvancedSessions.StartSessionCallbackProxyAdvanced.StartAdvancedSession");
		
		UStartSessionCallbackProxyAdvanced_StartAdvancedSession_Params params {};
		params.WorldContextObject = WorldContextObject;
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> PredefinedFunction UStartSessionCallbackProxyAdvanced.StaticClass
	 * 		Flags  -> (Predefined, Static)
	 */
	UClass* UStartSessionCallbackProxyAdvanced::StaticClass()
	{
		static UClass* ptr = nullptr;
		if (!ptr)
			ptr = UObject::FindClass("Class AdvancedSessions.StartSessionCallbackProxyAdvanced");
		return ptr;
	}
