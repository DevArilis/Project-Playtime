...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RP87[0x9C];                                  // 0x003C(0x009C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KSUA[0x390];                                 // 0x0028(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class UEditableMeshAdapter*>                        Adapters;                                                // 0x03B8(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_0U48[0x8];                                   // 0x03C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JSBI[0x148];                                 // 0x03D4(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_T3FF[0x1E4];                                 // 0x0524(0x01E4) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_3HHF[0xA4];                                  // 0x003C(0x00A4) MISSED OFFSET (PADDING)
