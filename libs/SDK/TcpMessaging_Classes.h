...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_ZDJA[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HJKQ[0x3];                                   // 0x0055(0x0003) MISSED OFFSET (PADDING)
