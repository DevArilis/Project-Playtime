...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_OutfitCat.ABP_OutfitCat_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_OutfitCat_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_Q7U8[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_OutfitCat(int32_t EntryPoint);
