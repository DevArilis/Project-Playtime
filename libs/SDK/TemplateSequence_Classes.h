...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_4J28[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_53SD[0x3];                                   // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GU2W[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5LCI[0x44];                                  // 0x062C(0x0044) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ER03[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_0NGC[0x2A8];                                 // 0x0028(0x02A8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BE15[0x60];                                  // 0x03C8(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1XVC[0x10];                                  // 0x0220(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_186I[0x4];                                   // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_4LP5[0x4];                                   // 0x0274(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EG7J[0x8];                                   // 0x04E8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_27L2[0x8];                                   // 0x0168(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_YI63[0x70];                                  // 0x0040(0x0070) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_XT4P[0x58];                                  // 0x0040(0x0058) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VJHW[0x50];                                  // 0x0040(0x0050) MISSED OFFSET (PADDING)
