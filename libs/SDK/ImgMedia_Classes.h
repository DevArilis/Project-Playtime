...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_EEU3[0x3];                                   // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_8G1P[0x4];                                   // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_M0F7[0x10];                                  // 0x00B8(0x0010) MISSED OFFSET (PADDING)
