...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_50D3[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GZ88[0x7];                                   // 0x0051(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_HV25[0x28];                                  // 0x0068(0x0028) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B822[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_6ANT[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_YK8Q[0x7];                                   // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_XJXA[0x20];                                  // 0x00A0(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_I2QW[0x10];                                  // 0x0058(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PR2Y[0x70];                                  // 0x0068(0x0070) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5CS8[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_5DC7[0xE];                                   // 0x00DA(0x000E) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9WK1[0x10];                                  // 0x0028(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BTRK[0x6];                                   // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WHPV[0x110];                                 // 0x0110(0x0110) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_R2TD[0xB];                                   // 0x0221(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZW8W[0x4];                                   // 0x023C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MCZ9[0x78];                                  // 0x0060(0x0078) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TWXH[0x2];                                   // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_4CI6[0x3];                                   // 0x0069(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_F0KV[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
