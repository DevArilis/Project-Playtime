...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_YWNH[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_0X74[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_4FDU[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
	};
