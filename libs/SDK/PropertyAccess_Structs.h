...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RXR1[0x2];                                   // 0x003E(0x0002) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_KK2C[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_Q36A[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_95F3[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_RTB5[0x6];                                   // 0x003A(0x0006) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_24ZH[0x18];                                  // 0x00B0(0x0018) MISSED OFFSET (PADDING)
	};
