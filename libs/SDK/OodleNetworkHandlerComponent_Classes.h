...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_RW9C[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IOQ8[0x7];                                   // 0x0099(0x0007) MISSED OFFSET (PADDING)
