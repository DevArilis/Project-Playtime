...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_DWWI[0x8];                                   // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_85SE[0x58];                                  // 0x00E8(0x0058) MISSED OFFSET (PADDING)
