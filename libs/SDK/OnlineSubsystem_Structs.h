...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XDIF[0x4];                                   // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_7MP0[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	};
