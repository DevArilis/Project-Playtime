...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_LKHS[0x3];                                   // 0x0011(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
		unsigned char                                              UnknownData_2M8R[0x4];                                   // 0x0014(0x0004) MISSED OFFSET (PADDING)
	};
