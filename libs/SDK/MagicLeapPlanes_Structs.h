...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_IC63[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_H303[0xE];                                   // 0x0052(0x000E) MISSED OFFSET (PADDING)
	};
