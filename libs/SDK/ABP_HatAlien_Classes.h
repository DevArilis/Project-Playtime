...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_HatAlien.ABP_HatAlien_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_HatAlien_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_K47G[0x8];                                   // 0x02B8(0x0008) Fix Super Size
