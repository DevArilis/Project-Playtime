...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D7HU[0x4];                                   // 0x0804(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QKMZ[0x6];                                   // 0x0812(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QW9E[0x1F];                                  // 0x0881(0x001F) MISSED OFFSET (PADDING)
