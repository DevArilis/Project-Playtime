...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_V14I[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_MKN6[0x6];                                   // 0x0482(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_124A[0x4];                                   // 0x04CC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
