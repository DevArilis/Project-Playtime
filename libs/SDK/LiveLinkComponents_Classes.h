...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_1ZXE[0x7];                                   // 0x0111(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_65Q8[0x6];                                   // 0x0152(0x0006) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_RT1P[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2O0G[0x2];                                   // 0x0046(0x0002) MISSED OFFSET (PADDING)
