...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_A17M[0x18];                                  // 0x0000(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_52B0[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FUserPlatform                                       Platform;                                                // 0x0020(0x0058) HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_HOID[0x30];                                  // 0x0078(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FUniqueNetIdRepl                                    PlatformUniqueId;                                        // 0x00A8(0x0028) HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_CS6L[0x30];                                  // 0x00D0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FString                                              PlatformSessionId;                                       // 0x0100(0x0010) ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_ZGW1[0x30];                                  // 0x0110(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QT0E[0x37];                                  // 0x0141(0x0037) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_86Q6[0x10];                                  // 0x0008(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<class USocialChatChannel*>                          ListenChannels;                                          // 0x0018(0x0010) ZeroConstructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_RSD0[0x18];                                  // 0x0028(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_WYYQ[0x8];                                   // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FPartyPrivacySettings                               PrivacySettings;                                         // 0x0020(0x0003) NoDestructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_SFMY[0x35];                                  // 0x0023(0x0035) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EHWH[0x18];                                  // 0x0068(0x0018) MISSED OFFSET (PADDING)
	};
