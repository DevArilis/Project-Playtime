...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_3SX6[0xA4];                                  // 0x032C(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_OPLJ[0x18];                                  // 0x0570(0x0018) MISSED OFFSET (PADDING)
