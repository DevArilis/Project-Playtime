...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_V1SG[0x7];                                   // 0x0019(0x0007) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6KW3[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		ECustomizedToolMenuVisibility                              Visibility;                                              // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_W88Y[0x3];                                   // 0x0001(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	};
	...
	public:
		...
		unsigned char                                              UnknownData_CCXX[0xE0];                                  // 0x0108(0x00E0) MISSED OFFSET (PADDING)
	};
