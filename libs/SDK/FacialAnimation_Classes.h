...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_J180[0x8];                                   // 0x0860(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_S7WY[0x2C];                                  // 0x0874(0x002C) MISSED OFFSET (PADDING)
