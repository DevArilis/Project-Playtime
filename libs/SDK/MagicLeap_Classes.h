...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_D2YV[0x8];                                   // 0x0120(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2O0C[0x50];                                  // 0x0180(0x0050) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_X741[0x8];                                   // 0x01F8(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_DBEL[0x6];                                   // 0x0212(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_03DA[0x3];                                   // 0x0221(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Q640[0x3];                                   // 0x0229(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EH7Q[0x5];                                   // 0x0233(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_GCCN[0x7];                                   // 0x0269(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_A6BR[0x14];                                  // 0x027C(0x0014) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_PMZV[0x5];                                   // 0x002B(0x0005) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GG1T[0x68];                                  // 0x00B0(0x0068) MISSED OFFSET (PADDING)
