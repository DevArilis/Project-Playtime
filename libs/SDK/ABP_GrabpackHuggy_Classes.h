...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_GrabpackHuggy.ABP_GrabpackHuggy_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_GrabpackHuggy_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_3T79[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_GrabpackHuggy(int32_t EntryPoint);
