...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_BNLW[0x4];                                   // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NKM1[0x6];                                   // 0x002A(0x0006) MISSED OFFSET (PADDING)
	};
