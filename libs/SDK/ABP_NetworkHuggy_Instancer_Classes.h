...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_NetworkHuggy_Instancer.ABP_NetworkHuggy_Instancer_C
	 * Size -> 0x0220 (FullSize[0x04D8] - InheritedSize[0x02B8])
	 */
	class UABP_NetworkHuggy_Instancer_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_WA1M[0x8];                                   // 0x02B8(0x0008) Fix Super Size
