...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_WQMX[0x78];                                  // 0x0028(0x0078) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_U598[0x180];                                 // 0x00B0(0x0180) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JD1K[0x48];                                  // 0x0028(0x0048) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8U60[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2C1Q[0x10];                                  // 0x00B0(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              pad_NYEO8GF9JX[0x01];                                    // 0x00A7(0x0001) PRE-DEFINED PROPERTY
		...
		unsigned char                                              pad_RIH4NO8OOJ[0x04];                                    // 0x00C4(0x0004) PRE-DEFINED PROPERTY
	...
	{
	public:
		unsigned char                                              UnknownData_QLUN[0x10];                                  // 0x00E0(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PWDJ[0x80];                                  // 0x0230(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_DM1W[0xB8];                                  // 0x0028(0x00B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_PH9L[0x30];                                  // 0x0030(0x0030) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_0QZZ[0x1B8];                                 // 0x0230(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_O67R[0xC8];                                  // 0x0028(0x00C8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_358S[0x1B8];                                 // 0x00E0(0x01B8) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EL0K[0xA0];                                  // 0x0028(0x00A0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OCPW[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SGFS[0x40];                                  // 0x0030(0x0040) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_OO22[0x10];                                  // 0x0070(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_CNH3[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JDOT[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_WOW7[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_LM1J[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_68ZW[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_QN8T[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_1J2N[0x28];                                  // 0x0070(0x0028) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FJ9X[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_JV1H[0x20];                                  // 0x0070(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_IA2Z[0x8];                                   // 0x0078(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_2J3R[0x8];                                   // 0x0070(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_FB9I[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
