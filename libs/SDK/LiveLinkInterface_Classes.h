...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IU11[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_DZND[0x107];                                 // 0x0059(0x0107) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_S8OU[0x7];                                   // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_8LS0[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
