...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_OutfitHoodie.ABP_OutfitHoodie_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_OutfitHoodie_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_9KPO[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_OutfitHoodie(int32_t EntryPoint);
