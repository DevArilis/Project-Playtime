...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IJMV[0xA8];                                  // 0x0000(0x00A8) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_6MLQ[0x18];                                  // 0x0008(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_LTE5[0x30];                                  // 0x0000(0x0030) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_USL8[0x28];                                  // 0x0000(0x0028) MISSED OFFSET (PADDING)
	};
