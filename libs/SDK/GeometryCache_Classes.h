...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_FQ1D[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1KU2[0x10];                                  // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_5CBO[0x4];                                   // 0x003C(0x0004) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_8DLK[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_T00H[0x1];                                   // 0x0483(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QOU4[0x34];                                  // 0x0498(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TLC6[0xF];                                   // 0x04D1(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2ULK[0x2C];                                  // 0x002C(0x002C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_E5A4[0x24];                                  // 0x005C(0x0024) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_190L[0x68];                                  // 0x0060(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y1G5[0xC];                                   // 0x00CC(0x000C) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_VYX2[0xB0];                                  // 0x0058(0x00B0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_GRFW[0xB0];                                  // 0x0058(0x00B0) MISSED OFFSET (PADDING)
