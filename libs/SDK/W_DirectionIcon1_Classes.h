...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_DirectionIcon1.W_DirectionIcon1_C
	 * Size -> 0x0010 (FullSize[0x0270] - InheritedSize[0x0260])
	 */
	class UW_DirectionIcon1_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_W_DirectionIcon1(int32_t EntryPoint);
