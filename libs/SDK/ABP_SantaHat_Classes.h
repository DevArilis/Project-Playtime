...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_SantaHat.ABP_SantaHat_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_SantaHat_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_N8W7[0x8];                                   // 0x02B8(0x0008) Fix Super Size
		...
		class USkeletalMeshComponent*                              NewVar_1;                                                // 0x0D40(0x0008) Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash

	public:
		void AnimGraph(struct FPoseLink* AnimGraph);
		void ExecuteUbergraph_ABP_SantaHat(int32_t EntryPoint);
