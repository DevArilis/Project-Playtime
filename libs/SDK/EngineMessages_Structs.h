...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_L7CV[0x3];                                   // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_2ML2[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_CN8O[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
