...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_NavEnemyIndicator.W_NavEnemyIndicator_C
	 * Size -> 0x0011 (FullSize[0x0271] - InheritedSize[0x0260])
	 */
	class UW_NavEnemyIndicator_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void Construct();
		void ExecuteUbergraph_W_NavEnemyIndicator(int32_t EntryPoint);
