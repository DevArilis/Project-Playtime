...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VO7R[0x8];                                   // 0x0478(0x0008) Fix Super Size
		...
		unsigned char                                              UnknownData_XLX2[0x3];                                   // 0x04D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_MU79[0x1C];                                  // 0x04F4(0x001C) MISSED OFFSET (PADDING)
