...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7MCQ[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_13AS[0x10];                                  // 0x0018(0x0010) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FI5V[0x8];                                   // 0x0010(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0EBF[0x8];                                   // 0x0020(0x0008) MISSED OFFSET (PADDING)
	};
