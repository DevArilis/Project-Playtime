...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_DPD8[0x2];                                   // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ALXL[0xF0];                                  // 0x02C0(0x00F0) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_DM1L[0x7];                                   // 0x0231(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_09HQ[0x7];                                   // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*>    AllInfoActors;                                           // 0x0228(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_0PA8[0x8];                                   // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_6EYU[0x8];                                   // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_PDWU[0xF];                                   // 0x00A1(0x000F) MISSED OFFSET (PADDING)
