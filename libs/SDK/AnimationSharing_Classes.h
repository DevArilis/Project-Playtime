...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_FTI2[0x7];                                   // 0x02C9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5NT7[0x8];                                   // 0x02D8(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_S2IV[0x3];                                   // 0x02CD(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KLNY[0x3];                                   // 0x02CD(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_EN89[0x50];                                  // 0x0038(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1TL4[0x38];                                  // 0x0090(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_P008[0x10];                                  // 0x00D8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_WQHB[0x20];                                  // 0x00F8(0x0020) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_TYQ1[0x40];                                  // 0x0048(0x0040) MISSED OFFSET (PADDING)
