...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_MinimapIcon_Waypoint.W_MinimapIcon_Waypoint_C
	 * Size -> 0x0014 (FullSize[0x0274] - InheritedSize[0x0260])
	 */
	class UW_MinimapIcon_Waypoint_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_W_MinimapIcon_Waypoint(int32_t EntryPoint);
