...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VGXP[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JAMO[0x18];                                  // 0x0078(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YF0Z[0x50];                                  // 0x0090(0x0050) MISSED OFFSET (PADDING)
