...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_GrabpackMommy.ABP_GrabpackMommy_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_GrabpackMommy_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_HWF0[0x8];                                   // 0x02B8(0x0008) Fix Super Size
