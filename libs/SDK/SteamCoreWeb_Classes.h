...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VKLP[0x18];                                  // 0x0030(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_MDS7[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IKEL[0x6];                                   // 0x0042(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QDK7[0x4];                                   // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_1XZ4[0x7];                                   // 0x0071(0x0007) MISSED OFFSET (PADDING)
