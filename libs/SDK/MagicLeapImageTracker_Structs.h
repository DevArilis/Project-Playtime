...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_54GA[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_GLTY[0x2];                                   // 0x001E(0x0002) MISSED OFFSET (PADDING)
	};
