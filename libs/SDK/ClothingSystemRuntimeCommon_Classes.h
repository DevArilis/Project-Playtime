...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_VFTF[0x4];                                   // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_4OG6[0x20];                                  // 0x0168(0x0020) MISSED OFFSET (PADDING)
