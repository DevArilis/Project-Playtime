...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_AltButton.UI_AltButton_C
	 * Size -> 0x0040 (FullSize[0x02A0] - InheritedSize[0x0260])
	 */
	class UUI_AltButton_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_UI_AltButton(int32_t EntryPoint);
