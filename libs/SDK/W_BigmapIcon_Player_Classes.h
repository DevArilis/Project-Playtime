...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass W_BigmapIcon_Player.W_BigmapIcon_Player_C
	 * Size -> 0x0014 (FullSize[0x0274] - InheritedSize[0x0260])
	 */
	class UW_BigmapIcon_Player_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_W_BigmapIcon_Player(int32_t EntryPoint);
