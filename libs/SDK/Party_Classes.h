...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_2D96[0x18];                                  // 0x0040(0x0018) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_37ZO[0x28];                                  // 0x0028(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NGU9[0x140];                                 // 0x0068(0x0140) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_KY37[0x30];                                  // 0x0028(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_9UHM[0x10];                                  // 0x0068(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_BG8R[0x77];                                  // 0x0119(0x0077) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_NQJX[0x8];                                   // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y26J[0x118];                                 // 0x01A8(0x0118) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_SWVG[0x40];                                  // 0x0028(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_D8F6[0x80];                                  // 0x0070(0x0080) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_251N[0x40];                                  // 0x0028(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0DS9[0x50];                                  // 0x0080(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ZSYM[0x118];                                 // 0x00E0(0x0118) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_HA06[0x50];                                  // 0x0028(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_V9XD[0x7];                                   // 0x0169(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TMap<struct FUniqueNetIdRepl, class USocialGroupChannel*>  GroupChannels;                                           // 0x0170(0x0050) NativeAccessSpecifierPrivate
		unsigned char                                              UnknownData_0831[0x60];                                  // 0x01C0(0x0060) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_Q9N5[0xC0];                                  // 0x0028(0x00C0) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_9N75[0x10];                                  // 0x00E8(0x0010) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_55PQ[0x60];                                  // 0x0028(0x0060) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_937K[0x10];                                  // 0x0080(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_IRVL[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_LZY3[0x140];                                 // 0x0028(0x0140) MISSED OFFSET (PADDING)
