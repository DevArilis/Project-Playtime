...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_3064[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_EN7J[0x4];                                   // 0x0074(0x0004) MISSED OFFSET (PADDING)
