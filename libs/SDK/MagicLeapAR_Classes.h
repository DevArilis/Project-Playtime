...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_PKC9[0xA8];                                  // 0x0238(0x00A8) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_BV7E[0x3];                                   // 0x0179(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QBOD[0x6];                                   // 0x019A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H82A[0x5];                                   // 0x005B(0x0005) MISSED OFFSET (PADDING)
