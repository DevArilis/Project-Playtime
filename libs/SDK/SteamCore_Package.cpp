...
namespace CG
{
	 ...
	 * 		bool                                               bAllowJoinInProgress                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	class USteamCoreUpdateSession* USteamCoreUpdateSession::UpdateSteamCoreSession(class UObject* WorldContextObject, TMap<class FString, struct FSteamSessionSearchSetting> Settings, const class FString& SessionName, int32_t MaxPlayers, bool bAllowJoinInProgress)
	{
		static UFunction* fn = nullptr;
		if (!fn)
	 ...
	 * Function:
	 * 		RVA    -> 0x00000000
	 * 		Name   -> Function SteamCore.SteamUtilities.GetType
	 * 		Flags  -> ()
	 * Parameters:
	...
	ESteamAttributeType USteamUtilities::GetType(const struct FSteamSessionSetting& Settings)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function SteamCore.SteamUtilities.GetType");
		
		USteamUtilities_GetType_Params params {};
		params.Settings = Settings;
	 ...
	 */
	bool USteamUtilities::GetInteger(const struct FSteamSessionSetting& Settings, class FString* Key, int32_t* OutValue)
	{
		static UFunction* fn = nullptr;
		if (!fn)
