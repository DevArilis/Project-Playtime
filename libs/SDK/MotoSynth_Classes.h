...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_7DAC[0x3];                                   // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5VAN[0x4];                                   // 0x00DC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		TArray<struct FGrainTableEntry>                            GrainTable;                                              // 0x00E0(0x0010) ZeroConstructor, Protected, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_387H[0x8];                                   // 0x00F0(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_B35P[0xB4];                                  // 0x06CC(0x00B4) MISSED OFFSET (PADDING)
