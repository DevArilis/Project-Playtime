...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass UI_AbilityComponent.UI_AbilityComponent_C
	 * Size -> 0x0054 (FullSize[0x02B4] - InheritedSize[0x0260])
	 */
	class UUI_AbilityComponent_C : public UUserWidget
	{
	public:
	...
	public:
		...
		void SetAbilityIconScale(const struct FVector2D& Scale);
