...
namespace CG
{
	 ...
	 * 		class FString                                      FieldName                                                  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	 */
	TArray<int32_t> UVaRestJsonObject::GetIntegerArrayField(const class FString& FieldName)
	{
		static UFunction* fn = nullptr;
		if (!fn)
			fn = UObject::FindObject<UFunction>("Function VaRest.VaRestJsonObject.GetIntegerArrayField");
