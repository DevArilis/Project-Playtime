...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_S4K2[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	};
	...
	{
	public:
		unsigned char                                              UnknownData_LJUF[0x10];                                  // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_71Y9[0x1];                                   // 0x0000(0x0001) MISSED OFFSET (PADDING)
	};
