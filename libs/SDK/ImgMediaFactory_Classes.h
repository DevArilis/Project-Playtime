...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_JOFG[0x3];                                   // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_0QNW[0x4];                                   // 0x004C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_7MSB[0x7];                                   // 0x0061(0x0007) MISSED OFFSET (PADDING)
