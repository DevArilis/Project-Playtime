...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_8FR9[0x3];                                   // 0x021D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_CLGA[0x4];                                   // 0x0224(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JQ0G[0x18];                                  // 0x0248(0x0018) MISSED OFFSET (PADDING)
