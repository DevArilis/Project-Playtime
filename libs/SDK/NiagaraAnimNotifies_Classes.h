...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_YM4V[0x1B];                                  // 0x0065(0x001B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SAGK[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_UYLT[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_FJMH[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_ZYZU[0x50];                                  // 0x0060(0x0050) MISSED OFFSET (PADDING)
