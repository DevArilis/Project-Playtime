...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * AnimBlueprintGeneratedClass ABP_ElfHat.ABP_ElfHat_C
	 * Size -> 0x0A90 (FullSize[0x0D48] - InheritedSize[0x02B8])
	 */
	class UABP_ElfHat_C : public UAnimInstance
	{
	public:
		unsigned char                                              UnknownData_ROB2[0x8];                                   // 0x02B8(0x0008) Fix Super Size
	...
	public:
		...
		void ExecuteUbergraph_ABP_ElfHat(int32_t EntryPoint);
