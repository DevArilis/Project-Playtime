...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_MNJR[0x1];                                   // 0x0217(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_HGPL[0x8];                                   // 0x0268(0x0008) MISSED OFFSET (PADDING)
