...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_X2AZ[0x3];                                   // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_QR25[0x3];                                   // 0x0009(0x0003) MISSED OFFSET (PADDING)
	};
	...
	public:
		...
		unsigned char                                              UnknownData_FKPX[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_BEU9[0x18];                                  // 0x0038(0x0018) MISSED OFFSET (PADDING)
	};
